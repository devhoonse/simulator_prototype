...
class CalendarTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.calendar: FactoryCalendar = FactoryCalendar()
    ...
    def test_setup_with_datetime(self):
        ...
        self.calendar.init(start_date=start_date, end_date=end_date,
        ...
        print(f"\tHORIZON : {self.calendar._horizonLen} {'seconds'}")
